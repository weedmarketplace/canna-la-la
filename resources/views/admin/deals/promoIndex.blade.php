            ...
            $(document).ready(function() {
                var dataTable =  $('#dataTable').DataTable({
                    ...
                    "columns": [
                        ...
                        { "data": "used", "name":'used', "orderable": true},
                ...
                $('#dataTable').on('click', '.item_edit', function (e) {
                    ...
                    itemPopup.load("{{route('aPromoGet')}}?id="+editId, function () {
                        this.open();
                    });
                });
                ...
                $('#add_item').on('click', function (e) {
                    ...
                    itemPopup.load("{{route('aPromoGet')}}", function () {
                        this.open();
                    });
                });
                $('#dataTable tbody').on('click', 'tr td:not(.selectOff)', function (e) {
