        ...
        <script>
            $(document).ready(function() {
                ...
                $('#dataTable_length select').change(function(){
                    var data = $('#dataTable_length select').val();
                    if(data == -1){
                ...
                $('#dataTable').on('click', '.item_edit', function (e) {
                    ...
                    itemPopup.load("{{route('sliderGet')}}?id="+editId, function () {
                        this.open();
                    });
                });
                ...
                $('#add_item').on('click', function (e) {
                    ...
                    itemPopup.load("{{route('sliderGet')}}", function () {
                        this.open();
                    });
                });
